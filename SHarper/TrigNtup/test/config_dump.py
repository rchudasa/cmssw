['file:/eos/cms/store/group/phys_diffraction/lbyl_2018/mc_flat_pt_photon/reco_lbl_modifier/flatpt_photon/reco_flat_pt_photon/190715_163552/0000/step3_RAW2DIGI_L1Reco_RECO_1.root']
reading in low pt pho regression from prep database
cms.string('103X_upgrade2018_realistic_HI_v11')
import FWCore.ParameterSet.Config as cms

process = cms.Process("HEEP")

process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_diffraction/lbyl_2018/mc_flat_pt_photon/reco_lbl_modifier/flatpt_photon/reco_flat_pt_photon/190715_163552/0000/step3_RAW2DIGI_L1Reco_RECO_1.root')
)
...
process.particleFlowSuperClusterECALNewReg = cms.EDProducer("EGSuperClusCorrector",
    colls = cms.VPSet(
        cms.PSet(
            coll = cms.InputTag("particleFlowSuperClusterECAL","particleFlowSuperClusterECALBarrel","@skipCurrentProcess"),
            outputLabel = cms.string('particleFlowSuperClusterECALBarrel')
        ), 
        cms.PSet(
            coll = cms.InputTag("particleFlowSuperClusterECAL","particleFlowSuperClusterECALEndcapWithPreshower","@skipCurrentProcess"),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('EGReg_tree_flatpt_photon_regression_applied_EDM.root'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('EGReg_tree_flatpt_photon_regression_applied.root')
)
...
process.egRegres = cms.ESSource("PoolDBESSource",
    DBParameters = cms.PSet(
        authenticationPath = cms.untracked.string(''),
        authenticationSystem = cms.untracked.int32(0),
        messageLevel = cms.untracked.int32(0),
